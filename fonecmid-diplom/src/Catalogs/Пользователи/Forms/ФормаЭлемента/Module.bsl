...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭлементКатегорияСотрудника = Элементы.Добавить("КатегорияСотрудника", Тип("ПолеФормы"), Элементы.ГруппаНаименование);
	ЭлементКатегорияСотрудника.Заголовок = "Категория сотрудника";
	ЭлементКатегорияСотрудника.Вид = ВидПоляФормы.ПолеВвода;
	ЭлементКатегорияСотрудника.ПутьКДанным = "Объект.ВКМ_КатегорияСотрудника";
